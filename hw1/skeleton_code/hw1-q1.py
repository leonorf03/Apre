...
class MLP(object):
    ...
    def backward(self, x, y, output, hiddens, loss_function='cross_entropy'):
        ...
        for i in range(len(self.W) - 1, -1, -1):
            ...
            grad_w = np.outer(grad_z, h)  # Compute weight gradient (outer product)
            grad_b = grad_z  # Gradient for biases is the gradient at this layer
    ...
    def train_epoch(self, X, y, learning_rate=0.001, **kwargs):
        ...
        for x_i, y_i in zip(X, y):
            ...
            # Compute the cross-entropy loss with epsilon 1e-10 to avoid log(0)
